...
function Projection_Pursuit(data::Matrix{Float64}, object_fun::Function; n_of_candidate::Int64=5 ,unit_sphere=nothing, fnscale::Int64=-1)
    n, p = size(data)
    ...
    proj_dirs[sortperm(proj_dirs[:, p+1], rev=true), :]
